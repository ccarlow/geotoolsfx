...
public class FeatureCollectionsController implements Initializable, FeatureCollectionsListener {
	...
	public void openFeatures() {
		...
		FXMLLoader fxmlLoader = new FXMLLoader(getClass().getClassLoader().getResource("geotoolsfx/fxml/FeatureCollection.fxml"));
		try {
	...
	public void openQuery() {
		TreeItem<String> treeItem = treeView.getSelectionModel().getSelectedItem();
		FXMLLoader fxmlLoader = new FXMLLoader(getClass().getClassLoader().getResource("geotoolsfx/fxml/Query.fxml"));
		try {
			Node root = (Node)fxmlLoader.load();
	...
	public void openQueries() {
		TreeItem<String> treeItem = treeView.getSelectionModel().getSelectedItem();
		FXMLLoader fxmlLoader = new FXMLLoader(getClass().getClassLoader().getResource("geotoolsfx/fxml/Queries.fxml"));
		try {
			Node root = (Node)fxmlLoader.load();
	...
	public void openFilters() {
		TreeItem<String> treeItem = treeView.getSelectionModel().getSelectedItem();
		FXMLLoader fxmlLoader = new FXMLLoader(getClass().getClassLoader().getResource("geotoolsfx/fxml/Filters.fxml"));
		try {
			Node root = (Node)fxmlLoader.load();
	...
	public void openSortBys() {
		TreeItem<String> treeItem = treeView.getSelectionModel().getSelectedItem();
		FXMLLoader fxmlLoader = new FXMLLoader(getClass().getClassLoader().getResource("geotoolsfx/fxml/SortBys.fxml"));
		try {
			Node root = (Node)fxmlLoader.load();
