...
public class MapGraphicController
    implements Initializable, MapLayerListListener, MapBoundsListener {
  @FXML
  ...
  public void setMapGraphics() {
    if (mapGraphic.getWidth() > 0 && mapGraphic.getHeight() > 0) {
      java.awt.Rectangle rect =
          new java.awt.Rectangle(0, 0, (int) mapGraphic.getWidth(), (int) mapGraphic.getHeight());
      mapContent.getViewport().setScreenArea(rect);
      paintArea.setBounds(0, 0, (int) mapGraphic.getWidth(), (int) mapGraphic.getHeight());
      BufferedImage bufferedImage = new BufferedImage((int) mapGraphic.getWidth(),
          (int) mapGraphic.getHeight(), BufferedImage.TYPE_INT_ARGB);
  ...
  public void mapGraphicMouseClicked(MouseEvent event) {
    if (ZOOM_OUT_MODE.equals(toolMode)) {
      ...
      DirectPosition2D corner =
          new DirectPosition2D(mapPos.getX() - 0.5d * mapGraphic.getWidth() / newScale,
      ...
      ReferencedEnvelope refEnv = new ReferencedEnvelope(newMapArea.getMinimum(0),
          newMapArea.getMaximum(0), newMapArea.getMinimum(1), newMapArea.getMaximum(1), crs);
  ...
  public void mapGraphicMouseReleased(MouseEvent event) {
    if (PAN_MODE.equals(toolMode)) {
      ...
      mapContent.getViewport().setBounds(
          new ReferencedEnvelope(env, mapContent.getViewport().getCoordinateReferenceSystem()));
