...
public abstract class FeatureCollectionFilterCombinator {
	protected List<FeatureCollectionFilterCombinatorCollegue> collegues = new ArrayList<FeatureCollectionFilterCombinatorCollegue>();
	protected static final FilterFactory2 ff = CommonFactoryFinder.getFilterFactory2(GeoTools.getDefaultHints());
